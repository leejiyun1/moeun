...
export const DRINK_INFO_ROWS = (data: ProductDetail) => [
  {
    label: '맛 정보',
    value: data.drink
      ? `단맛 ${data.drink.taste_profile.sweetness}, 산미 ${data.drink.taste_profile.acidity}, 탄산감 ${data.drink.taste_profile.carbonation}, 쓴맛 ${data.drink.taste_profile.bitterness}, 바디감 ${data.drink.taste_profile.body}, 향 ${data.drink.taste_profile.aroma}`
      : '-',
  },
